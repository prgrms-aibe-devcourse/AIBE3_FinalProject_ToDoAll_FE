...
export default function JobPostCard({
  ...
  return (
    <article
      ...
      className={
        'group relative w-full overflow-hidden rounded-2xl bg-white p-3 shadow-sm ring-1 ring-gray-200 transition hover:shadow-md focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 sm:p-4 ' +
        className
      }
    >
